...
def get_recommendations(title):
    ...
    return_df['Rating'] = sorted(df2['vote_average'].iloc[movie_indices])
    return return_df
...
#        check = difflib.get_close_matches(m_name,all_titles,cutout=0.50,n=1)
        if m_name not in all_titles:
            ...
            return flask.render_template('found.html',movie_names=names,movie_homepage=homepage,search_name=m_name, movie_releaseDate=releaseDate,movie_rating=vote_average)
